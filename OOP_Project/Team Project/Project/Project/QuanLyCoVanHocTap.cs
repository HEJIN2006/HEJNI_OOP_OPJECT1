...
namespace Project
{
    public partial class QuanLyCoVanHocTap : Form
    {
        ...
        private void textBox_DiemCuoiKy_TextChanged(object sender, EventArgs e)
        {
        ...
        private void tàiChínhSinhViênToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void QuanLyCoVanHocTap_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
    }
